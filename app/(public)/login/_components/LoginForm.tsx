...
const perks = [
  "Join your live classes directly from the dashboard.",
  "Check your personalized AI practice exercises for today.",
  "Review vocabulary decks based on your latest interactions.",
];
...
export function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // TODO: replace with authClient.signIn(email, password)
    ...
    <>
        ...
        <div className="relative z-10 p-12 flex flex-col h-full justify-between">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-extrabold mb-7 leading-tight">
              Welcome back to your fluency journey.
            </h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-10 lg:p-12 relative overflow-hidden bg-muted/20 lg:bg-background">
        ...
        >
          ...
          {/* Card wrapper — visible on mobile, transparent on desktop */}
